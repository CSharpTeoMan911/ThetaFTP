...
{
    public class GoogleValidationDatabaseController : Controller
    {
                ...
                if (value?.code != null)
                {
                    if (Shared.sha512 != null)
                    {
                        ...
                        try
                        {
                            ...
                            try
                            {
                                validation_command.CommandText = "SELECT Log_In_Code FROM google_log_in_sessions_waiting_for_approval WHERE Log_In_Code = @Log_In_Code";
                                ...
                                try
                                {
                                    if (await reader.ReadAsync() == true)
                                    {
                                        ...
                                        try
                                        {
                                            approval_command.CommandText = "DELETE FROM google_log_in_sessions_waiting_for_approval WHERE Log_In_Code = @Log_In_Code";
