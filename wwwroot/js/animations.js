...
function BackgroundGradientFluctuation() {
    ...
    background.style.cssText = "; background: linear-gradient(to right, #626161 " + gradient_value + "%, #dbd7d7); -webkit-background: linear-gradient(to right, #626161 " + gradient_value + "%, #dbd7d7); background: --moz-linear-gradient(to right, #626161 " + gradient_value + "%, #dbd7d7);";
